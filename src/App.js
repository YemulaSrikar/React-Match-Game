...
class ImageAndTabs extends Component {
  state = {
  ...
  render() {
    const filteredLists = this.getProjectsList()
    const {score, activeTabId, timer, showResults, displayedImage} = this.state
    return (
      <div>
        <nav className="nav-container">
          <div className="img-score-sec-container">
            <img
            ...
            <ul className="score-time-container">
              ...
              <li className="timer-icon-container">
                <img
        ...
        <div className="bg-img-container">
          ...
          />
          {!showResults ? (
            <div className="images-tabs-list-container">
              <ul className="tabs-u-list">
              ...
              <ul className="images-u-list">
                {filteredLists.map(eachImg => (
                  <ImageItem
                    TabDetails={eachImg}
                    key={eachImg.id}
            ...
            <ResultCard
              onRestartAgain={this.onRestartAgain}
              finalScore={score}
            />
          )}
        </div>
